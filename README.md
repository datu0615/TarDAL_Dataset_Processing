...
This repository provides code for pre-processing on the M^3FD dataset.
Dataset download can be downloaded through the M^3FD dataset download provided below.
The pre-processing contents are as follows.

1. Divide the train and test in class balance.
2. Replace the annotation xml file with the yolo format.
